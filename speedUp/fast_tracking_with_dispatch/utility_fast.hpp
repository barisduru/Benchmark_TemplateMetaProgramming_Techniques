...
namespace details{
	...
	struct join_select<1>{
		template< typename = list<>, typename = list<>, typename = list<>,typename = list<>, typename = list<>, typename = list<>, typename = list<>, typename = list<> > 
		struct join;
		template< typename ...T0s, typename ...T1s, typename ...T2s, typename ...T3s, typename ...T4s, typename ...T5s, typename ...T6s, typename ...T7s >
		struct join< list<T0s...>, list<T1s...>, list<T2s...>, list<T3s...>, list<T4s...>, list<T5s...>, list<T6s...>, list<T7s...> >{
			using type = list< T0s..., T1s..., T2s..., T3s..., T4s..., T5s..., T6s...,T7s... >;
		};//type
	};//join8
	...
	struct join_select<6>{
		...
		struct join< list<T0s...>, list<T1s...>, list<T2s...>, list<T3s...>, list<T4s...>, list<T5s...>, list<T6s...>, list<T7s...>, 
					 ...
					 list<T120s...>, list<T121s...>, list<T122s...>, list<T123s...>, list<T124s...>, list<T125s...>, list<T126s...>, list<T127s...>,
					 TAIL_LISTS...>{
			using type = typename join_select<find_dispatch(sizeof...(TAIL_LISTS) + 1)>::template join<
						 list< T0s..., T1s..., T2s..., T3s..., T4s..., T5s..., T6s...,T7s...,
							   T8s..., T9s..., T10s..., T11s..., T12s..., T13s..., T14s...,T15s...,
							   T16s..., T17s..., T18s..., T19s..., T20s..., T21s..., T22s...,T23s...,
							   T24s..., T25s..., T26s..., T27s..., T28s..., T29s..., T30s...,T31s...,
							   T32s..., T33s..., T34s..., T35s..., T36s..., T37s..., T38s...,T39s...,
	...
	struct join{
		using type = typename join_select<find_dispatch(sizeof...(Containers))>::template join<Containers...>::type;
	};

	template<typename ...Containers>
	using join_t = typename join<Containers...>::type;


	template<typename Container, template<typename >class Function>
	struct transform;

	template<typename ...Ts,template<typename >class Function>
	struct transform<list<Ts...>,Function>{
		using type = list<typename Function<Ts>::type...>;
	};

	template<typename Container,template<typename >class Function>
	using transform_t = typename transform<Container,Function>::type;

	
	template<template<typename >class Predicate, typename T>
	struct variant : std::conditional<Predicate<T>::value,
						list<>,
						list<T>
						>{};
	...
	struct functor{
		template<typename T>
		using f = variant<Predicate,T>;
	};

	template<typename Unit_Containers>
	struct merge;
	template<template<typename ...>class LIST,typename ...Ts>
	struct merge<LIST<Ts...>> : join<Ts...>{};
	template<typename Unit_Containers>
	using merge_t = typename merge<Unit_Containers>::type;
...
struct remove_if{
	using type = details::merge_t<details::transform_t<Container,details::functor<Predicate>::template f>>;
};
template<template<typename >class Predicate,typename Container>
using remove_if_t = typename remove_if<Predicate,Container>::type;

static_assert(std::is_same_v<remove_if_t<std::is_void,list<void,int,bool,int,void,float>>,list<int,bool,int,float>>,"");
static_assert(std::is_same_v<remove_if_t<std::is_void,list<void,int,bool,int,void,float,bool,bool,int,int,float,float,void,void,bool,bool,int,float,double,void,void,double>>,
